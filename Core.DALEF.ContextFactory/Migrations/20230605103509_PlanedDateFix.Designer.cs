...
namespace Core.DALEF.ContextFactory.Migrations
{
    ...
    [Migration("20230605103509_PlanedDateFix")]
    partial class PlanedDateFix
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IPSTemplate.Dal.Models.Identity.TEIdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SecurityStamp = "b382fc2f-847a-4175-a399-ec9dd01942b6",
                        ...
                        new
                        {
                            ...
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "4f062a0f-2b9d-42f3-bb6f-f3817be01c06",
                            TwoFactorEnabled = false,
                            UserName = "Member"
                        });
                });
            ...
            modelBuilder.Entity("IPSTemplate.Dal.Models.TECategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("TECategory");
                });

            modelBuilder.Entity("IPSTemplate.Dal.Models.TECheckout", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IPSTemplate.Dal.Models.TEMember", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IPSTemplate.Dal.Models.TEBook", b =>
                {
                    b.HasOne("IPSTemplate.Dal.Models.TECategory", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("IPSTemplate.Dal.Models.TECheckout", b =>
                {
                    ...
                    b.HasOne("IPSTemplate.Dal.Models.TEMember", "Member")
                        .WithMany()
